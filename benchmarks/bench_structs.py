...
BENCHMARKS = [
    ("structtype", "structtype", structtype_template),
...
def print_header():
    ...
    for lib in ("structtype", "attrs", "msgspec", "pydantic"):
        try:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark structtype Struct operations")
    parser.add_argument(
        "-b",
        "--bench-name",
        dest="bench_names",
