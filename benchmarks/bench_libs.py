...
def bench(name, st_fn, ms_fn, pd_fn, st_data, ms_data, pd_data):
    n = 200
...
bench(
    ...
    lambda data: [o.model_dump() for o in data],
    order_st,
    order_ms,
    order_pd,
)
...
bench(
    ...
    lambda data: [Order_pd.model_validate(d) for d in data],
    dicts_raw,
    dicts_raw,
    dicts_raw,
)
...
bench(
    ...
    lambda data: [o.model_dump_json() for o in data],
    order_st,
    order_ms,
    order_pd,
)
...
bench(
    ...
    lambda data: [Order_pd.model_validate_json(b) for b in data],
    json_st,
    json_ms,
    json_pd,
)
...
bench(
    ...
    lambda b: Dir_pd.model_validate_json(b),
    tagged_json_st,
    tagged_json_ms,
    tagged_json_pd,
)
