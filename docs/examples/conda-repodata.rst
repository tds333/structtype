...
- ``structtype`` is the fastest option tested. It relies on defining a known
...
<https://github.com/tds333/structtype/tree/main/examples/conda-repodata>`__.
