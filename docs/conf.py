...
try:
    ...
    structtype.UnsetType = UnsetType
except ImportError:
    pass
...
html_theme_options = {
    "light_logo": "structtype-logo-light.svg",
    "dark_logo": "structtype-logo-dark.svg",
    "light_css_variables": {
...
default_role = "obj"
extlinks = {
    "issue": ("https://github.com/tds333/structtype/issues/%s", "Issue #%s"),
    "pr": ("https://github.com/tds333/structtype/pull/%s", "PR #%s"),
}
