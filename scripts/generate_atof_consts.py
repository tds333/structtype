"""This script generates structtype/atof_consts.h"""
...
#ifndef STRUCTTYPE_ATOF_CONSTS_H
#define STRUCTTYPE_ATOF_CONSTS_H
...
if __name__ == "__main__":
    ...
    path = os.path.join(repo, "src", "structtype", "atof_consts.h")
